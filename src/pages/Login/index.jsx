            ...
            >
                ...
                {mode === "login" && (
                    <>
                        ...
                        <form onSubmit={handleSignIn}>
                            <input style={{ width: "100%", padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,245,255,0.2)", color: "#fff", marginBottom: 12 }} type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} maxLength={128} autoComplete="email" required />
                            <input style={{ width: "100%", padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,245,255,0.2)", color: "#fff", marginBottom: 6 }} type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} maxLength={128} autoComplete="current-password" required />
                        ...
                        <div style={{ textAlign: "center", marginTop: 24, fontSize: "0.85rem", color: "var(--txt2)" }}>
                ...
                {mode === "reset" && (
                    <>
                        ...
                        <form onSubmit={handleReset}>
                            <input style={{ width: "100%", padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,245,255,0.2)", color: "#fff", marginBottom: 16 }} type="email" placeholder="Email address" value={email} onChange={e => setEmail(e.target.value)} maxLength={128} autoComplete="email" required />
                ...
                {mode === "register" && (
                    <form onSubmit={handleRegister}>
                        <input style={{ width: "100%", padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,245,255,0.2)", color: "#fff", marginBottom: 12 }} type="text" placeholder="Full Name" value={name} onChange={e => setName(e.target.value)} maxLength={64} autoComplete="name" required />
                        <input style={{ width: "100%", padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,245,255,0.2)", color: "#fff", marginBottom: 12 }} type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} maxLength={128} autoComplete="email" required />
                        <input style={{ width: "100%", padding: 12, borderRadius: 8, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,245,255,0.2)", color: "#fff", marginBottom: 16 }} type="password" placeholder="Password (min 6 chars)" value={password} onChange={e => setPassword(e.target.value)} minLength={6} maxLength={128} autoComplete="new-password" required />
